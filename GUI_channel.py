...
class LinearCodeGUI(tk.Tk):
    ...
    def _show_public_key_matrix(self):
        ...
        win.title(f"Public generator matrix")
        win.geometry("750x500")

        ttk.Label(
            win,
            text=f"Public generator matrix (shape = {G_tag.shape[0]} x {G_tag.shape[1]})",
    ...
    def _update_single_plaintext_state(self):
        ...
        if mode == "manual":
            ...
            if self.single_manual_plaintext_bits:
                ...
                self.single_plaintext_summary.configure(
                    text=" click 'Message Insert' to enter a message "
                )
        else:
    ...
    def _draw_single_run_cards(self, report: dict):
        ...
        # -------- Card 2: Transmission details (antenna) --------
        ...
        tx_fields = [
            ...
            ("Received message:", report.get("Received r = c ⊕ e_tot")),
        ...
        crc_ok = bool(report.get("CRC success", False))
        ...
        res_fields = [
            ("CRC success:", _yes_no_icon(crc_ok)),
